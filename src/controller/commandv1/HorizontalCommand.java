...
/**
 * This class represents the horizontal-flip command, and runs the designated methods in the
 * model.
 */
public class HorizontalCommand implements ICommand {
  @Override
  public void runCommand(Scanner sc, ImageProcessorView view, ImageProcessorModel model) {
    ...
    try {
      target = sc.next();
      name = sc.next();
      model.horizontalFlip(target, name);
